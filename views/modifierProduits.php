  ...
  if (isset($_POST['image'])) {
   ...
   $quantite=$_POST['quantite'] ;
    ...
    $description=$_POST['description'];
        ...
        $produitC1->modifierProduits($idprod,$nom,$qualite,$description,$prix,$quantite,$disponibilite,$image);
        //echo "youpii";
...
<style type="text/css">
 ...
 <table class="text-center table table-data2">
  <div >
    ...
    <input   class="controle" type="file" name="image" id="image" value="upload" >
    </div>
</br>
