...
$produits=new produits($_GET['idprod'],$_GET['nom'],$_GET['idcategorie'],$_GET['qualite'],$_GET['description'],$_GET['prix'],$_GET['quantite'],$_GET['disponibilite'],$_GET['image']);
include "../core/ProduitsCore.php";
$produits1C=new ProduitsCore();
$produits1C->ajouterProduits($produits);

header('Location:http:../store/afficherProduits2.php ');
...
<tr align="center">
<td align="center">Identifiant du produit</td>
<td align="center"><input  class="controle"type="number" name="idprod" id="idprod"   min="1" max="1000" required placeholder="Entre 1 et 1000" ></td>
</tr>
  
<tr align="center">
<td align="center">Nom</td>
<td align="center"><input class="controle" type="text" name="nom" id="nom" required  pattern=".{2,}" placeholder="De 1 ou plus caractères"></td>
</tr>
<tr align="center">
<td>Categorie</td>
<td><select class="controle" name="idcategorie">
    <?PHP
foreach($listeCategories as $row){
    ?>
    <option value="<?PHP echo $row['idcategorie']; ?>"><?PHP echo $row['marque'] ?>
    </option>
    <?PHP } ?>
</select> 
</td>
...
<td align="center"><input class="controle" type="text" name="qualite" id="qualite" required  pattern=".{2,}" placeholder="De 2 ou plus caractères"></td>
</tr>

<td align="center">Description</td>
<td align="center"><input class="controle" type="text" name="description" id="description" required  pattern=".{2,}" placeholder="De 1 ou plus caractères"></td>
</tr>
<td align="center">Prix</td>
<td align="center"><input class="controle" type="number" name="prix" id="prix"  min="1" max="5000" required placeholder="Entre 1 et 5000"></td>
</tr>
<td align="center">Quantité</td>
<td align="center"><input class="controle" type="number" name="quantite" id="quantite"  min="0" max="1000" required placeholder="Entre 0 et 1000"></td>
</tr>
<td align="center">Disponibilité</td>
<td align="center"><input  class="controle" type="text" name="disponibilite" id="disponibilite" required  pattern=".{2,}" placeholder="De 1 ou plus caractères"></td>
</tr>
<tr align="center">
 <td align="center">Importer une image</td>
   <td align="center"> <input  type="file" name="image" id="image" value="upload" ></td>
 </tr>
<tr align="center">
<td align="center"></td>

<td align="center"><input class="inpu" type="submit" name="ajouter" value="Ajouter" ></td>
</tr>
