...
<!doctype html>
<link rel="shortcut icon" type="image/x-icon" href="img/jih.png">
...
.fe { font: bold 2.5em Arial Black, sans-serif;
  text-align: center;
  letter-spacing: 1px
    /* basic font setting */
  color: #0056b3;
...
foreach($listeProduits as $row){
  ...
  <td align="center" width="100"
     height="100" ><?PHP echo $row['marque']; ?></td>
...
<div>
  <td align="center"><a class="lien" href="modifierProduits.php?idprod=<?PHP echo $row['idprod']; ?>" >Modifier</a></td>
  </tr>  </div>
