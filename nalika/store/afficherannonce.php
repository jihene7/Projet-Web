...
$listeannonces=$annonce1C->afficherannonces();
...
<link rel="icon" href="images/logo.png">
 ...
 <section class="hero-wrap hero-wrap-2" style="background-image: url('images/lm.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            <p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.html"> <i class="fa fa-chevron-right"></i></a></span> <span> annonces <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread"> liste annonces</h2>
          </div>
        </div>
      </div>
    </section>
