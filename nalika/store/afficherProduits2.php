...
<head>
    <title>Catalogue du Produits</title>
    <meta charset="utf-8">
...
<link rel="icon" href="images/logo.png">
  ...
  <body>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                <a class="dropdown-item" href="afficherProduits2.php">liste des produits</a>
          <li class="nav-item"><a href="contact.html" class="nav-link">Contact</a></li>
         <li class="nav-item"><a href="afficherannonce.php" class="nav-link">Annonce</a></li>
        <li class="nav-item"><a href="seif/views/afficherEmploye.php" class="nav-link">Clients</a></li>
        <li class="nav-item"><a href="afficherevenement.php" class="nav-link">Events</a></li>
         <li class="nav-item dropdown">
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/lou.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span> <span> Produits <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">Liste des produits</h2>
          </div>
        </div>
      </div>
    </section>
  ...
  <form method="GET" action="rechercherListeProduits2.php"class="formulaire"  align="center" >
   
   

                                               
   
 <input   required  pattern=".{2,}" placeholder="De 2 ou plus caractères"class="champ" type="text" id="nom" name="nom" value="rechercher...">
...
<img  height="25" width="25" src="cher2.png"/>
  ...
  <div class="b" >
    ...
    <center  >
     ...
     <div class="bo" align="center"  >
       <b >  Entrez la marque du produit</b><br></br>
     
        <input  required  pattern=".{2,}" placeholder="De 2 ou plus caractères"  type="text" id="marque" name="marque">
    </div>
    ...
    <input  class="bo" align="center" type="submit" name="afficher le(s) produit(s)" value="Afficher " >
        ...
        <div id ="si"><b>Trie par :</b>
        	
             
  
<button type="submit" class="button"  text-align="right"> 

<i><a href="triProduits.php" ><span class="user"> Nom</span></a></i>
</button>
<button type="submit" class="button"> 

<a href="triProduits2.php" ><span class="user"><i> Prix</i></span></a>
</button>
...
<br> </br>
   ...
   <h4 class="bo" align="center" > Galerie :</h4>                                  
               ...
               <dd><b class="f"> Marque :</b><i> <?PHP echo $row['marque']; ?></i></dd>
                <dd><b class="f">Qualité :</b><i> <?PHP echo $row['qualite']; ?></i></dd>
                 <dd><b class="f">Description :</b><i> <?PHP echo $row['description']; ?></i></dd>
                  <dd><b class="f">Prix :</b><i> <?PHP echo $row['prix']; ?></i></dd>
