...
<link rel="icon" href="images/logo.png">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="http://localhost/nalika/store/about.htmll" class="nav-link">About</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/yy.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            <p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span> <span> Clients <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">Clients</h2>
          </div>
        </div>
      </div>
    </section>
...
<br> </br>
   ...
   <h4 class="bo" align="center" > Clients :</h4>  
