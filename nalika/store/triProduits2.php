...
$listeProduits=$produits1C->triPrix();
...
<head>
    ...
    <title>Trier les produits  par prix</title>
       
          
                      
                        <h3 align="center" class="feu">Tri par prix</h4>
               ...
               <h4  align="center">
                ...
                <dd><b>Qualité :</b><i> <?PHP echo $row['qualite']; ?></i></dd>
                 <dd><b>Description :</b><i> <?PHP echo $row['description']; ?></i></dd>
                  <dd><b>Prix :</b><i class="f"> <?PHP echo $row['prix']; ?></i></dd>
