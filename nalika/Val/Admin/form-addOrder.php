...
$list=$U1C->getUsers();
header('Location:http:../tables-Orders.php ');
    ?>
...
<table align="center">
 ...
 .feu { font: bold 2.5em Arial Black, sans-serif;
  ...
  body {
    ...
    background-image: url("img/logo/f11.jpg");
...
<body>
                        ...
                        <h4 align="center"  class="feu"> Ajouter commande</h4> 
                          <br></br>
                <form method="POST" action="addOrder.php" align="center" class="g">
