    ...
    <div class="container">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row"><form method="post" action="pdff.php">
                    <div class="iadded">
	...
	<div id="deleteEmployeeModal" class="modal fade">
		<div class="modal-dialog">
            ...
            <br>
			 ...
			 <div class="col-12 text-right"><a class="btn btn-primary" href="pdff.php" target="_blank"><i class="fa fa-print"></i> pdf version</a></div>
