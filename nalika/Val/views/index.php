...
<body>
    ...
    <div class="wrap">
            <div class="container">
                ...
                <div class="reg">
                    <p class="mb-0"><a href="inscrire.html">Sign Up</a> <a href="login.html">Log In</a></p>
                </div>
                    </div>
                </div>
            </div>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
          <a class="navbar-brand" href="index.html">Gam Ing <span>store</span></a>
