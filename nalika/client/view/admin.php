...
<ul class="nav sidebar-inner" id="sidebar-menu">
    ...
    <li  class="has-sub active" >
      ...
      <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#pages"
        ...
        <span class="nav-text">Gerer Client</span> <b class="caret"></b>
      </a>
      <ul  class="collapse"  id="pages"
        ...
        <div class="sub-menu">
              ...
              <li >
                <a class="sidenav-item-link" href="afficherEmploye.php">
                  <span class="nav-text">Afficher Client</span>
                  
                </a>
              </li>
            
          <li >
                <a class="sidenav-item-link" href="afficherRecover.php">
                  <span class="nav-text">Afficher Code</span>
                  
                </a>
              </li>
              <li >
                <a class="sidenav-item-link" href="phpmailer/mail.php">
                  <span class="nav-text">envoyer un mail</span>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li class="dropdown-footer">
                        <a href="login.php"> <i class="mdi mdi-logout"></i> Log Out </a>
                      </li>
                    </ul>
                  </li>
                </ul>
