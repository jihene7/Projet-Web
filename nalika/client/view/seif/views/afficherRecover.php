...
$listeRecovers=$recover1C->afficherRecovers();
...
<br></br>
            ...
            <h4 align="center"  class="feu">Recupèrer mot de passe</h4>
...
<?PHP
foreach($listeRecovers as $row){
	?>
	<tr>
	<td><?PHP echo $row['email']; ?></td>
	<td><?PHP echo $row['code']; ?></td>
	<td><form method="POST" action="supprimerRecover.php">
