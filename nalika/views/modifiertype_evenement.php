...
if (isset($_GET['id_type'])){
    ...
    $result=$type_evenementC->recuperertype_evenement($_GET['id_type']);
...
if (isset($_POST['modifier'])){
	$type_evenement=new type_evenement($_POST['id_type'],$_POST['competition'],$_POST['giveaway']);
	$type_evenementC->modifiertype_evenement($type_evenement,$_POST['id_type_ini']);
	echo $_POST['id_type_ini'];
...
<head>
    ...
    <title>Modifier  type events</title>
...
<tr>
<td></td>
<td><input type="hidden" name="id_type_ini" value="<?PHP echo $_GET['id_type'];?>"></td>
</tr>
</table>
</form>
<?php
