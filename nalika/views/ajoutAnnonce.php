...
$annonce=new annonce($_GET['id_annonce'],$_GET['id_offre'],$_GET['id_produit'],$_GET['description'],$_GET['date_annonce'],$_GET['date_limite'],$_GET['id_client']);
include "../core/annonceC.php";
$annonce1C=new annonceC();
$annonce1C->ajouterAnnonce($annonce);

header('Location:http:../store/afficherannonce.php ');
...
$offreC=new offreC();
$listeoffre=$offreC->afficheroffres();
                ...
                <div class="container">
                    <div class="row">
                     ...
                     <br></br>              
                        ...
                        <h4 align="center"  class="feu"> Ajouter annonce</h4> 
                          <br></br>
                                <style type="text/css">
...
<tr align="center">
<td align="center">Identifiant de l'annonce</td>
<td align="center"><input  class="controle"type="number" name="id_annonce" id="id_annonce"   min="1" max="1000" required placeholder="Entre 1 et 1000" ></td>
</tr>
  <tr align="center">
<td>Id offre</td>
<td><select class="controle" name="id_offre">
    <?PHP
foreach($listeoffre as $row){
    ?>
    <option value="<?PHP echo $row['id_offre']; ?>"><?PHP echo $row['id_offre'] ?>
    </option>
    <?PHP } ?>
</select> 
</td>
...
<tr align="center">
<td align="center">id_produit</td>
<td align="center"><input class="controle" type="number" name="id_produit" id="id_produit" min="1" max="1000" required placeholder="Entre 1 et 1000" ></td>
</tr>
...
<td align="center">date_annonce</td>
<td align="center"><input class="controle" type="text" name="date_annonce" id="date_annonce" required  pattern=".{2,}" placeholder="De 2 ou plus caractères "></td>
</tr>


<td align="center">date_limite</td>
<td align="center"><input class="controle" type="text" name="date_limite" id="date_limite" required  pattern=".{2,}" placeholder="De 2 ou plus caractères"></td>
</tr>

<td align="center">id_client</td>
<td align="center"><input  class="controle" type="number" name="id_client" id="id_client"  min="1" max="1000" required placeholder="Entre 1 et 1000"></td>
</tr>
...
<td align="center"><input class="input" type="submit" name="ajouter" value="Ajouter" ></td>
</tr>
