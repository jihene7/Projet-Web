...
$event=new evenement($_GET['id_evenement'],$_GET['nom'],$_GET['date'],$_GET['id_client'],$_GET['nbrmax'],$_GET['id_type'],$_GET['competition'],$_GET['giveaway']);
include "../core/evenementC.php";
$event1C=new evenementC();
$event1C->ajouterevenement($event);

header('Location:http:afficherevenement.php ');
...
$listeTypes=$type_evenementC->affichertype_evenements();
...
<tr align="center">
<td align="center">Identifiant d'event</td>
<td align="center"><input  class="controle"type="number" name="id_evenement" id="id_evenement"   min="1" max="1000" required placeholder="Entre 1 et 1000" ></td>
</tr>
...
<td align="center"><input class="controle" type="text" name="date" id="date" required  pattern=".{2,}" placeholder="De 2 ou plus caractères"></td>
</tr>
<td align="center">id_client</td>
<td align="center"><input class="controle" type="number" name="id_client" id="id_client"  min="1" max="5000" required placeholder="Entre 1 et 5000"></td>
</tr>


<td align="center">Nombre max</td>
<td align="center"><input class="controle" type="number" name="nbrmax" id="nbrmax"  min="1" max="1000" required placeholder="Entre 1 et 1000"></td>
</tr>
<tr align="center">
<td>Id type</td>
<td><select class="controle" name="id_type">
    <?PHP
foreach($listeTypes as $row){
    ?>
    <option value="<?PHP echo $row['id_type']; ?>"><?PHP echo $row['id_type'] ?>
    </option>
    <?PHP } ?>
</select> 
</td>
...
<td align="center"><input  class="controle" type="text" name="competition" id="competition" required  pattern=".{2,}" placeholder="De 2 ou plus caractères"></td>
</tr>
<td align="center">giveaway</td>
<td align="center"><input  class="controle" type="text" name="giveaway" id="giveaway" required  pattern=".{2,}" placeholder="De 2 ou plus caractères"></td>
</tr>
