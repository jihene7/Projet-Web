...
$listetype_evenements=$type_evenement1C->affichertype_evenements();

//var_dump($listetype_evenements->fetchAll());
?>
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Afficher type event</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        <h4 align="center"  class="feu"> Afficher type event</h4> 
                          <br></br>
...
<?PHP
foreach($listetype_evenements as $row){
	?>
	<tr>
