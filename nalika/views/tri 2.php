...
$listeCategories=$categorie1C->triMarque();
...
<head>
    ...
    <title>Trier les catégories</title>
...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            ...
            <h4 align="center"  class="feu">Trie des catégories</h4>
...
#box1:hover
{
  ...
  body {
    ...
    background-image: url("img/logo/f5.jpg");
