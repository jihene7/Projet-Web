...
<td align="center"><input class="controle" type="text" name="nom" id="nom" required  pattern=".{2,}" placeholder="De 2 ou plus caractères"></td>
</tr>
<tr align="center">
<td>Categorie</td>
...
<td align="center"><input class="controle" type="text" name="description" id="description" required  pattern=".{2,}" placeholder="De 2 ou plus caractères"></td>
</tr>
...
<td align="center"><input  class="controle" type="text" name="disponibilite" id="disponibilite" required  pattern=".{2,}" placeholder="De 2 ou plus caractères"></td>
</tr>
<tr align="center">
