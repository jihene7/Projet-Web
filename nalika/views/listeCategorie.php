...
<head>
    ...
    <title>la liste des  categories</title>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            ...
            <br></br>
             <br></br>
              <br></br>
            <h4 align="center"  class="feu">Liste des Catégories</h4>
...
.feu { font: bold 2.5em Arial Black, sans-serif;
  ...
  body {
    color: #9d4f00;
      background-image: url("img/logo/off.gif");
...
<table border="2" align="center"  width="400" length="400" id="box1">
