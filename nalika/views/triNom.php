...
<head>
    ...
    <title>Trier les produits</title>
...
<td bgcolor="white" align="center">Nom</td>
<td bgcolor="white" align="center">Categorie</td>
<td bgcolor="white" align="center">Qualité</td>
<td bgcolor="white" align="center">Description</td>
<td bgcolor="white" align="center">Prix</td>
<td bgcolor="white" align="center">Quantité</td>
<td bgcolor="white" align="center">Disponibilité</td>
<td bgcolor="white" align="center">Image</td>
...
foreach($listeProduits as $row){
	...
	<td bgcolor="white" align="center"><?PHP echo $row['nom']; ?></td>
	<td bgcolor="white" align="center"><?PHP echo $row['marque']; ?></td>
	<td bgcolor="white" align="center"><?PHP echo $row['qualite']; ?></td>
	<td bgcolor="white" align="center"><?PHP echo $row['description']; ?></td>
	<td bgcolor="white" align="center"><?PHP echo $row['prix']; ?></td>
    <td bgcolor="white" align="center"><?PHP echo $row['quantite']; ?></td>
    <td bgcolor="white" align="center"><?PHP echo $row['disponibilite']; ?></td>
	<td class="zoom" align="center" ><img width="200"
     height="200"src="../core/<?php echo $row['image']; ?>" /></br> 
