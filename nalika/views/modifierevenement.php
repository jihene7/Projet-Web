...
if (isset($_POST['modifier'])){
	$evenement=new evenement($_POST['id_evenement'],$_POST['nom'],$_POST['date'],$_POST['id_client'],$_POST['nbrmax'],$_POST['id_type'],$_POST['competition'],$_POST['giveaway']);
	$evenementC->modifierevenement($evenement,$_POST['id_evenement_ini']);
	echo $_POST['id_evenement_ini'];
...
<br></br>
<br></br>
 <h4 align="center"  class="feu"> Modifier event</h4> 
...
<tr>
<td>id_evenement</td>
<td><input type="number" name="id_evenement" value="<?PHP echo $id_evenement ?>"></td>
</tr>
<tr>
<td>nom</td>
...
<tr>
<td>nbrmax</td>
<td><input type="number" name="nbrmax" value="<?PHP echo $nbrmax ?>"></td>
</tr>
<tr>

<td>id_type</td>
<td><input type="number" name="id_type" value="<?PHP echo $id_type ?>"></td>
</tr>
<tr>
<td>competition</td>
<td><input type="text" name="competition" value="<?PHP echo $competition ?>"></td>
</tr>
<tr>
<td>giveaway</td>
<td><input type="text" name="giveaway" value="<?PHP echo $giveaway ?>"></td>
</tr>
<td></td>
...
<tr>
<td></td>
<td><input type="hidden" name="id_evenement_ini" value="<?PHP echo $_GET['id_evenement'];?>"></td>
</tr>
<tr>
</table>
</form>
