  ...
  if (isset($_POST['modifier'])) {
   ...
   $quantite=$_POST['quantite'] ;
    ...
    $description=$_POST['description'];
        ...
        $produitC1->modifierProduits($idprod,$nom,$qualite,$description,$prix,$quantite,$disponibilite);
        //echo "youpii";
...
<br></br>
 ...
 <h4 align="center"  class="feu"> Modifier produits</h4> 
...
body {
background-image: url("img/logo/9.jpg");
 ...
 <table class="text-center table table-data2">
  <div >
    ...
    <center>
        ...
        <input class="controle" type="number" name="idprod" value="<?php echo $idprod; ?>" disabled>
        <input type="hidden" name="idprod"  value="<?PHP echo $idprod ?>">
        </div>
         <div>
        <label>Catégorie</label></br>
        <input type="number"   class="controle" id= "idcategorie" name="idcategorie" value="<?php echo $idcategorie ?>"disabled>
    </div>
  
    <div>
        <label>Nom</label></br>
        <input   class="controle" required  pattern=".{2,}" placeholder="De 2 ou plus caractères" type="text" id= "nom" name="nom" value="<?php echo $nom ?>">
    </div>
    
   
    <div>
        <label>Qualité</label></br>
        <input  class="controle" required  pattern=".{2,}" placeholder="De 2 ou plus caractères" type="text" name="qualite" id="qualite" value="<?php echo $qualite ?>">
    </div>
    <div>
        <label>Description</label></br>
        <input   class="controle" required  pattern=".{2,}" placeholder="De 2 ou plus caractères" name="description" id="description" value="<?php echo $description ?>">
    </div>
     <div>
        <label>Prix</label></br>
        <input   class="controle" min="1" max="5000" required placeholder="Entre 1 et 5000" type="number" name="prix" id="prix" value="<?php echo $prix ?>">

    </div>
     <div>
        <label>Quantité</label></br>
        <input   class="controle" min="0" max="1000" required placeholder="Entre 0 et 1000" type="number" name="quantite" id="quantite" value="<?php echo $quantite ?>">

    </div>
     <div>
        <label>Disponibilité</label></br>
        <input  class="controle" required  pattern=".{2,}" placeholder="De 2 ou plus caractères" type="text" name="disponibilite" id="disponibilite" value="<?php echo $disponibilite ?>">
   ...
   <input class="button" type="submit" name="modifier" id="modifier" value="Modifier" href="afficherProduits.php" >
