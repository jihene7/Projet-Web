...
if (isset($_GET['idcategorie'])){
  $categorieC=new CategorieCore();
    $result=$categorieC->recupererCategorie($_GET['idcategorie']);
...
if (isset($_POST['modifier'])){
  $categorie=new categorie($_POST['idcategorie'],$_POST['marque']);
  $categorieC->modifierCategorie($categorie,$_POST['idcategorie_ini']);
  echo $_POST['idcategorie_ini'];
  header('Location: afficherCategorie.php');
}
?>
  <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>  Modifier Categorie </title><meta name="description" content="">
...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            ...
            <br></br>
            <br></br>
            <h4 align="center"  class="feu">Modifier catégorie</h4>
...
<style type="text/css">
  ...
  body {
    ...
    background-image: url("img/logo/lovvv.gif");
...
<tr align="center">
<td align="center">Identifiant du catégorie</td>
<td align="center"><input  class="controle"type="number" name="idcategorie" min="1" max="5000" required placeholder="Entre 1 et 5000" value="<?PHP echo $idcategorie ?>"></td>
</tr>
<tr align="center">
<td align="center">Marque</td>
<td align="center"><input type="text"  class="controle" required  pattern=".{2,}" placeholder="De 2 ou plus caractères" name="marque" value="<?PHP echo $marque ?>"></td>
</tr>
...
<tr align="center">
<td></td>
<td align="center"><input type="hidden" name="idcategorie_ini" value="<?PHP echo $_GET['idcategorie'];?>"></td>
</tr>
</table>
</form>
<?PHP
