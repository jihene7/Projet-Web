...
<link rel="icon" href="images/logo.png">
 ...
 <input   required  pattern=".{2,}" placeholder="De 1 ou plus caractères"class="champ" type="text" id="nom" name="nom" value="rechercher...">
    ...
    <center  >
     ...
     <div class="bo" align="center"  >
       <b >  Entrez la marque du produit</b><br></br>
        ...
        <input  required  pattern=".{2,}" placeholder="De 1 ou plus caractères"  type="text" id="marque" name="marque">
    </div>
